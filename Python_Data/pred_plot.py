...
#%%
path = "Test_Data_030621/"
fn1 = path + '0309c_pp_MC2.csv'
...
dat_1, pred_1 = get_frame(dat_1, pred_1, 8300, 8300+900)
...
thre_f = 305 # Est. background position(cm)
thre_c = 245 # Est. target position(cm)
